 ...
 *
 * 说明：
 * 1.wait();  notify();  notifyAll();     这三个方法必须使用在同步方法，或同步代码块中
 * 2.wait();  notify();  notifyAll();     这三个方法的调用者，必须式同步代码块或同步方法中的同步监视器
 * 3.wait();  notify();  notifyAll();     这三个方法是定义在java.long.Object类中
 *
 * 面试题：
 *      sleep()和wait()的异同
