...
/**
 *
 * 一：说明：Java中的对象，正常情况下，只能进行比较：== 或 ！=.不能使用>或<的，但是在开发场景中，
 * ，我们需要对多个对象进行排序，言外之意，就需要比较对象的大小
 * 如何实现？使用两个接口中任何一个：Comparable或Comparator
 *
...
public class CompareTest {
    ...
    1.背景：
        当元素的类型没有实现java.long.Comparable接口而不方便修改代码，
        或者实现了java.long.Comparable接口的排序规则不适合当前的操作。
...
//                return 0;
    ...
    public void test4(){
        ...
        Arrays.sort(arr, new Comparator() {
            //指明商品比较大小的方式：按照商品名称从低到高排序，再按照价格从高到低排序
            @Override
            public int compare(Object o1, Object o2) {
